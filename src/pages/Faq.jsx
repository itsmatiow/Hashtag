...
const faqs = [
  {
    ...
    answer:
      "بله! ما قبل از شروع پروژه، تا جایی که نیازا و اهداف شما دقیقا مشخص بشه بهتون مشاوره می‌دیم تا به بهترین راه‌حل برسیم.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "ما توی هشتگ، از تکنولوژیای به‌روز و مدرن استفاده می‌کنیم، ولی اینکه دقیقاً برای پروژه شما سراغ کدوم ابزار بریم، بستگی به نیاز پروژه داره که تو جلسه‌ی مشاوره بررسیش می‌کنیم.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "بله، بعد از تحویل پروژه، ما یک دوره پشتیبانی رایگان ارائه می‌دهیم تا هرگونه مشکل را برطرف کنیم. مدت زمان این دوره، با توجه به نیاز شما تعیین میشه",
  },
  {
